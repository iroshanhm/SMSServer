 ...
 * @author Iroshan
 */
public class LoanOutstanding_infrm_view_3 extends javax.swing.JInternalFrame {
...
// WAITING DIALOG - END ******************************************
     ...
     */
    private static LoanOutstanding_infrm_view_3 arrears_infrm_view = null;
...
//    static Map<Integer, Loan_pojo> loanOutstandingMap;
    ...
    public LoanOutstanding_infrm_view_3() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblPending.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SELECT", "#", "CODE", "NAME", "ACCOUNT", "PHONE", "MESSAGE", "STATUS"
            }
        ) {
...
//        tblSelectProsesing ();        
    ...
    public static LoanOutstanding_infrm_view_3 getArrears_infrm_view() {
        return arrears_infrm_view;
    }

    public static void setArrears_infrm_view(LoanOutstanding_infrm_view_3 arrears_infrm_view) {
        LoanOutstanding_infrm_view_3.arrears_infrm_view = arrears_infrm_view;
    }
...
//    }
    ...
    public static void setLoanOutstandingList(List<Loan_pojo> loanOutstandingList) {
        LoanOutstanding_infrm_view_3.loanOutstandingList = loanOutstandingList;
    }
...
// "SELECT", "#", "CUSTOMER CODE", "PHONE", "MESSAGE", "A/C", "GRANTED DATE", "GRANTED AMOUNT", "ARREARS CAPITAL", "ARREARS INTEREST", "TOTAL ARREARS AMOUNT", "STATUS"
                dfTblMdPending.addRow(new Object[]{
                    isSelected, pendingSeqId, cusCode, cusName, acNumber, phoneNo, message, msgStatus
                });
...
// SEND
                        ...
                        Logger.getLogger(LoanOutstanding_infrm_view_3.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }
        });
