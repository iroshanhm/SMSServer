 ...
 * @author Iroshan
 */
public class LoanDisbursed_infrm_view extends javax.swing.JInternalFrame {

    /**
     * Creates new form CustomerUploder
     */
SendMessage sendMessage = null;
    private static LoanDisbursed_infrm_view arrears_infrm_view = null;
...
//    List<Arrears_pojo> arearsList = null;
    ...
    public LoanDisbursed_infrm_view() {
        initComponents();
    ...
    @SuppressWarnings("unchecked")
          ...
          private void initComponents() {
                    ...
                    tblPending.setModel(new javax.swing.table.DefaultTableModel(
                              ...
                              new String [] {
                                        "STATUS", "SELECT", "#", "MESSAGE", "CODE", "ACCOUNT OFFICE NO", "NAME", "PHONE", "A/C", "GRANTED AMOUNT", "GRANTED DATE", "NO OF TERMS"
                              }
                    ) {
                    ...
                    if (tblPending.getColumnModel().getColumnCount() > 0) {
                              tblPending.getColumnModel().getColumn(0).setResizable(false);
                    }
...
//        tblSelectProsesing ();
    ...
    public static LoanDisbursed_infrm_view getArrears_infrm_view() {
        return arrears_infrm_view;
    }

    public static void setArrears_infrm_view_1(LoanDisbursed_infrm_view arrears_infrm_view) {
        LoanDisbursed_infrm_view.arrears_infrm_view = arrears_infrm_view;
    }
        ...
        Runnable runBle = new Runnable() {
            ...
            public void run() {
                ...
                if (dateSelected == null) {
                    ...
                    loanArrearsList = new Loan_service().getLoanDisbursementDetails(dateSelected, productCodeAndName, centerCodeAndName, customer);
                    loadArrearsToTables();
                }
...
//            Loan_pojo value = entrySet.getValue ();
            ...
            String noOfTerms = MyRounding.roundToWithoutDecimal(value.getNoOfTerms());
            ...
            if (msgStatus.equalsIgnoreCase(MessageStatusEnum.PENDING.toString())) {
                ...
                dfTblMdPending.addRow(new Object[]{
                    //                                                  "STATUS", "SELECT", "#", "MESSAGE", "CODE", "ACCOUNT OFFICE NO", "NAME", "PHONE", "A/C", "GRANTED AMOUNT", "GRANTED DATE", "NO OF TERMS"
                    msgStatus, isSele, pendingSeqId, message, cusCode, cusOfficeNo, cusName, phoneNo, acNumber, loanAmount, disburseDate, noOfTerms
                });
            ...
            public void run() {
                ...
                if (MyMessagesUtility.showConfirmDoYouWantToRemove("Confirm ?") == 0) {
                    ...
                    try {
                        ...
                        String messageType = MyMessageTypeEnum.DISBURSEMENT.toString().trim();


//		    OutboundMessage.MessageStatuses confirmEnd = loan_service.sendSMS_2(Company_Profile.getConfirmTeleNo(), "Jurnal sending end.", null, null);
                        ...
                        if (!confirmStart.toString().trim().equals(MessageStatusEnum.SENT.toString().trim())) {
                            MyMessagesUtility.showWarning("Loan disburded " + confirmStart.toString());
                        ...
                        for (int i = currentRow; i < rowCount; i++) {
                            ...
                            Boolean isSelected = Boolean.valueOf(String.valueOf(dfTblMd.getValueAt(i, 1)));
                            if (isSelected) {
                                if (!dfTblMd.getValueAt(i, 0).toString().trim().equalsIgnoreCase(OutboundMessage.MessageStatuses.SENT.toString())) {
//                                String voucherNo = String.valueOf (dfTblMd.getValueAt (i, 2));
//                                String cusCode = String.valueOf (dfTblMd.getValueAt (i, 3));

                                    String phoneNo = String.valueOf(dfTblMd.getValueAt(i, 7));
                                    String message = String.valueOf(dfTblMd.getValueAt(i, 3));
...
// SEND
                                    ...
                                    dfTblMd.setValueAt(msgStatus.toString(), i, 0);
                                }
                        ...
                        if (!confirmEnd.toString().trim().equals(MessageStatusEnum.SENT.toString().trim())) {
                            MyMessagesUtility.showWarning("Loan disburded " + confirmEnd.toString());
                        ...
                        Logger.getLogger(LoanDisbursed_infrm_view.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }
        });
