 ...
 * @author Iroshan
 */
public class MessageToMemebers_view_2 extends javax.swing.JInternalFrame {

    ShowMessageDetails_INF showMessageDetails_INF = new ShowMessageDetails_INF();
    
    
    SendMessage sendMessage = null;
    private static MessageToMemebers_view_2 messageToMemebers_view;
    ...
    public static MessageToMemebers_view_2 getMessageToMemebers_view() {
        return messageToMemebers_view;
    }

    public static void setMessageToMemebers_view(MessageToMemebers_view_2 aMessageToMemebers_view) {
     ...
     */
    public MessageToMemebers_view_2() {
        initComponents();
            ...
            public void run() {
                ...
                if (MyMessagesUtility.showConfirmDoYouWantToRemove("Confirm ?") == 0) {
                    ...
                    if (!msg.isEmpty()) {
                        ...
                        try {
                            OutboundMessage.MessageStatuses confirmStart = sendMessage.sendConfirm_1(Company_Profile.getConfirmTeleNo(), "Message to member 1 sending start..");
                            if (!confirmStart.toString().trim().equals(MessageStatusEnum.SENT.toString().trim())) {
                                MyMessagesUtility.showWarning("Message to member 1 " + confirmStart.toString());
...
// SEND
                            ...
                            OutboundMessage.MessageStatuses confirmEnd = sendMessage.sendConfirm_1(Company_Profile.getConfirmTeleNo(), "Message to member 1 sending end with " + sentSMSCount + " messages.");
                            if (!confirmEnd.toString().trim().equals(MessageStatusEnum.SENT.toString().trim())) {
                                MyMessagesUtility.showWarning("Message to member 1 " + confirmEnd.toString());
                            ...
                            Logger.getLogger(MessageToMemebers_view_2.class.getName()).log(Level.SEVERE, null, ex);
                        }
